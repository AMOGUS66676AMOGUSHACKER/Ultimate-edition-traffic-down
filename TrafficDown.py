...
# Ответ на вопрос, почему тут пробелы вместо табов встречаются: я начинал делать на телефоне, а там табы хуй поставишь, вот по этому пробелы и использовал, ведь с ними точно также
...
packages = ['requests', 'tkinter', 'threading', 'customtkinter', 'colorama', 'socket']
for package in packages: 
 ...
 if not installed:
  ...
  if package not in ['customtkinter', 'tkinter']:exec(f'import {package}')
